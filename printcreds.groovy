/**
 * This script can be used to decrypt Jenkins credentials.
 * You can execute is in the Jenkins script console https://www.jenkins.io/doc/book/managing/script-console/
 * It will return all credentials/password in cleartext
 */
